...
| @deepseek-ai/dsh-plan-execute | 0.0.1 | BSD-3-Clause |
...
| @deepseek-ai/dsh-session-health | 0.0.1 | SEE LICENSE FILE |
...
| @deepseek-ai/dsh-toolkit | 0.0.1 | SEE LICENSE FILE |
...
| @dsh-external/dsh-input-history | 0.1.1 | BSD-3-Clause |
| @dsh-external/dsh-session-search | 0.1.0 | BSD-3-Clause |
| @dsh-external/dsh-ui-progress | 0.9.1 | BSD-3-Clause |
| @dsh-external/zotero-harvest | 0.2.0 | MIT |
| @earendil-works/pi-ai | 0.82.1 | MIT |
| @esbuild/win32-arm64 | 0.28.2 | MIT |
| @esbuild/win32-x64 | 0.28.2 | MIT |
| @fisfzy/zotero-wave-rag | 0.7.2 | SEE LICENSE FILE |
...
| @libsql/win32-x64-msvc | 0.5.29 | MIT |
...
| @univerjs-pro/cli-assets | 0.1.0 | NONE (exception: owner-distributed internal build; see docs/science-layer.md) |
| @univerjs-pro/engine-formula-rust-binding | 1.0.0-insiders.20260819-8209aa8 | NONE (exception: owner-distributed internal build; see docs/science-layer.md) |
| @univerjs-pro/engine-formula-rust-binding-win32-x64-msvc | 1.0.0-insiders.20260819-8209aa8 | NONE (exception: owner-distributed internal build; see docs/science-layer.md) |
| @univerjs-pro/exchange-node-binding | 0.1.0 | NONE (exception: owner-distributed internal build; see docs/science-layer.md) |
| @univerjs-pro/exchange-node-binding-win32-x64-msvc | 0.1.0 | NONE (exception: owner-distributed internal build; see docs/science-layer.md) |
...
| dsh-cae-agent | 0.2.3 | MIT |
| dsh-community-market | 0.1.0-dev.0 | MIT |
| dsh-danus | 0.1.0 | Apache-2.0 |
| dsh-ego-browser | 0.8.0 | MIT |
| dsh-focus-chat | 0.1.0 | BSD-3-Clause |
| dsh-model-inherit | 0.1.0 | MIT |
| dsh-science | 0.1.0 | MIT |
| dsh-univer-office | 0.2.9-fork.6 | Apache-2.0 |
| dsh-ventus-plugins | 0.2.0 | MIT |
...
| markdown-it-ts | 1.1.0 | MIT |
| markdown-table | 3.0.4 | MIT |
| marked | 16.4.2 | MIT |
| markstream-core | 1.0.3 | MIT |
| markstream-react | 0.0.55 | MIT |
...
| statuses | 2.0.2 | MIT |
| stream-markdown | 0.0.16 | MIT |
| stream-markdown-parser | 1.1.4 | MIT |
