 ...
 */
export async function probeZoteroApi(base, timeoutMs = 2000) {
    try {
...
export async function addItemViaApi(base, p) {
    try {
...
export async function attachPdfViaApi(base, itemKey, pdfPath) {
    try {
