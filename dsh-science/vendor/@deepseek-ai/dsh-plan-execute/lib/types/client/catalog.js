 ...
 */
export function routeValueOf(draft) {
 ...
 */
export function modelOptionLabel(groupName, model) {
 ...
 * @returns option label.
 */
export function inheritRouteLabel(resolved, inheritLabel) {
 ...
 * @returns option label.
 */
export function inheritEffortLabel(model, inheritLabel) {
