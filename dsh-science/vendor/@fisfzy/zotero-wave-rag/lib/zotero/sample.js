 ...
 */
const a = (firstName, lastName) => ({ firstName, lastName });
/** Papers lacking explicit annotations get an empty list (type default). */
const withDefaults = (papers) => papers.map((p) => ({ annotations: [], ...p }));
export const SAMPLE_PAPERS = withDefaults([
    {
        key: 'rag-survey',
    ...
    },
    {
        ...
        year: 2024,
        abstract: 'Query-focused summarization over large private corpora is hard for naive RAG because information is scattered across many sources. Graph RAG builds a knowledge graph over the corpus with an LLM, partitions it into communities, and pre-computes community summaries; at query time it aggregates the most relevant community summaries to answer questions whose answers span the whole corpus. Graph RAG substantially improves comprehensiveness and diversity of answers on a million-token news corpus.',
    ...
    },
    {
        ...
        year: 2024,
        abstract: 'LightRAG introduces a lightweight graph-based retrieval paradigm that integrates graph structures into text indexing and retrieval, supporting both keyword and semantic queries with dual-level retrieval over entities and relations. It requires only one LLM call to index the graph, runs fast, and improves answer completeness and retrieval efficiency compared to baselines including Graph RAG and vector-only RAG.',
    ...
    },
    {
        ...
        year: 2024,
        abstract: 'Vector databases are the retrieval backbone of generative-AI applications: they store embeddings, support approximate nearest neighbor search, and provide CRUD, metadata filtering and hybrid search. This survey compares the design of major vector databases (Milvus, Pinecone, Weaviate, Qdrant), covering indexing (IVF, HNSW, PQ), distance functions, and the trade-offs between recall, latency and memory.',
    ...
    },
    {
        ...
        year: 2023,
        abstract: 'This work builds a comprehensive benchmark for RAG evaluation, covering answer generation quality, context utilization, and noise robustness. It finds that LLMs are sensitive to retrieval quality and context order, and proposes NOISESET to test robustness against irrelevant or conflicting retrieved passages — a widely used reference for RAG evaluation methodology.',
    ...
    },
    {
        ...
        year: 2021,
        abstract: 'SimCSE produces high-quality sentence embeddings with contrastive learning: unsupervised SimCSE predicts a sentence from itself using dropout as noise, and supervised SimCSE uses NLI entailment pairs. It consistently beats prior sentence-embedding methods on STS tasks and transfers well to retrieval-style similarity search.',
    ...
    },
    {
        ...
        year: 2019,
        abstract: 'Natural Questions (NQ) is a large-scale benchmark of real anonymized Google search queries with answers annotated in Wikipedia pages. NQ became the standard evaluation for open-domain QA and drove the transition from extractive readers to retrieval-augmented pipelines.',
    ...
    },
    {
        ...
        year: 2020,
        abstract: 'ColBERT introduces late interaction: queries and passages are encoded separately into token-level embeddings, then matched with a lightweight MaxSim operator. This retains the expressiveness of cross-encoders at near bi-encoder speed, substantially improving passage ranking effectiveness.',
    ...
    },
    {
        ...
        year: 2019,
        abstract: 'This work shows that a BM25 first stage followed by a cross-encoder re-ranker achieves state-of-the-art results on passage retrieval benchmarks, establishing the standard two-stage retrieval architecture used in later RAG pipelines.',
    ...
    },
    {
        ...
        year: 2023,
        abstract: 'Self-RAG trains a model to decide when to retrieve, generate with or without retrieved evidence, and critique its own outputs with reflection tokens. It improves factual accuracy and quality across open-domain QA and long-form generation while using retrieval only when needed.',
    ...
    },
    {
        ...
        year: 2022,
        abstract: 'HyDE generates a hypothetical document from the query with an LLM and embeds it instead of the query, retrieving passages whose embedding is close to the hypothetical document. It closes much of the gap to supervised dense retrievers in zero-shot settings.',
    ...
    },
    {
        ...
        year: 2024,
        abstract: 'Adaptive-RAG routes each query by its complexity: simple questions skip retrieval, moderate ones use single-pass retrieval, and complex ones trigger multi-step retrieval with a feedback loop. The router is trained to predict which strategy fits, improving accuracy and efficiency.',
    ...
    },
    {
        ...
        year: 2024,
        abstract: 'RAG-Fusion generates multiple query variations from the user question, retrieves for each, and fuses the result sets with reciprocal rank fusion before generation, improving recall and answer quality by covering more query angles.',
    ...
    },
    {
        ...
        year: 2009,
        abstract: 'BM25 is the canonical sparse retrieval scoring function, balancing term frequency saturation and document length normalization. This survey explains its components and variants, and why sparse and dense retrieval remain complementary.',
    ...
    },
    {
        ...
        year: 2013,
        abstract: 'TransE models relations as translations in embedding space: for a triple (h, r, t), the embedding of the head plus the relation should approximate the tail embedding. It became the baseline for knowledge graph embedding research.',
    ...
    },
    {
        ...
        year: 2018,
        abstract: 'R-GCN extends graph convolutional networks to relational graphs with typed edges, learning entity and relation representations for link prediction and node classification on knowledge bases.',
    ...
    },
    {
        ...
        year: 2024,
        abstract: 'A survey and framework for grounding LLMs in knowledge graphs: entities are retrieved from the KG, verbalized into natural language, and injected into prompts, improving answer grounding and reducing hallucination compared to text-only retrieval.',
    ...
    },
    {
        ...
        year: 2022,
        abstract: 'ReAct interleaves reasoning traces and tool actions in a single language model rollout, letting the model reason about what to do, act, and observe the result. It outperforms both pure reasoning and pure acting on knowledge and decision benchmarks.',
    ...
    },
    {
        ...
        year: 2023,
        abstract: 'Reflexion agents convert task feedback into verbal self-reflection stored in an episodic memory buffer, which is replayed on later attempts. The mechanism improves decision-making agents without weight updates.',
    ...
    },
    {
        ...
        year: 2023,
        abstract: 'RAGAS evaluates RAG pipelines without ground-truth answers by scoring faithfulness, answer relevance, and context relevance with LLM judgments, providing a reference framework for automated RAG evaluation.',
    ...
    },
    {
        ...
        year: 2022,
        abstract: 'TruthfulQA probes whether models generate truthful answers rather than mimicking popular misconceptions. Its adversarial design exposes knowledge limitations that retrieval augmentation is often proposed to address.',
        tags: ['llm', 'eval', 'benchmark', 'knowledge'],
        collections: ['评测'],
    ...
    },
    {
        ...
        year: 2021,
        abstract: 'Milvus is an open-source vector database with a storage/computation separation architecture, supporting multiple ANN indexes, metadata filtering and hybrid search, and is a common retrieval backend for production RAG systems.',
    ...
    },
    {
        ...
        year: 2017,
        abstract: 'The Transformer architecture replaces recurrence with self-attention, enabling massively parallel training and becoming the backbone of modern NLP models used across retrieval and generation.',
    ...
    },
    {
        ...
        year: 2023,
        abstract: 'This survey maps how large language models are applied to recommendation, from item-textualization and generative ranking to conversational and retrieval-augmented designs, and analyzes evaluation protocols for generative recommenders.',
