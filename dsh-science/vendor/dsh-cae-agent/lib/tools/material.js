    ...
    ctx.tools.register(defineTool({
        ...
        parameters: {
            ...
            table: {
                type: 'string',
                required: true,
                description: 'JSON array of rows, e.g. "[[E1,E2,E3,nu12,nu13,nu23,G12,G13,G23]]" for ENGINEERING_CONSTANTS, or [[D11,D22,D33,D12,D13,D23,D44,D55,D66]] for ORTHOTROPIC.',
            },
        ...
        async execute(args, exec) {
            ...
            const r = await runKernelCode(br, `from abaqusConstants import ENGINEERING_CONSTANTS, ORTHOTROPIC, ANISOTROPIC
...
result={"model":${model},"name":mat.name,"elasticType":${JSON.stringify(etype)},"rows":len(_tbl)}`, config.timeoutMs, exec.signal);
            return r.value;
        },
        timeoutMs: config.timeoutMs,
        isConcurrencySafe: () => false,
